...
authoring and maintaining Azure Logic Apps**, starting from a Consumption
baseline and extending into a side-by-side Standard migration story. It
contains a working skeleton workflow, the Bicep that deploys it, and a set
of pre-scripted scenarios you can run live.
...
scripts/deploy-standard.csx         # generated Standard deploy script for Scenario 05
scripts/invoke.csx                   # POST a sample to the trigger URL (auto-fetches the URL)
scripts/invoke-standard.csx         # generated Standard invoke script for Scenario 05
...
docs/                                # generated during Scenarios 01 and 05
standard/                            # generated during Scenario 05
infra-standard/                      # generated during Scenario 05
...
…or use your preferred REST client with the same approval payload described
in the scenario prompts.
...
Scenarios 05–06 use a **side-by-side Logic Apps Standard** project that is
created during the demo flow. The original Consumption deployment under
`infra/` stays in place so both runtimes can be compared live; the Standard
folders below appear after you complete Scenario 05.
...
The full migration plan is generated during Scenario 05 at
`docs/migration-consumption-to-standard.md` and is intentionally throwaway
for the live workshop flow.
